...
export default function EnrollForm() {
    ...
    return (
        ...
        <div className="flex flex-col items-center gap-4 w-full  p-4 md:p-5">
          <p className="text-2xl md:text-[36px] text-[#2F327D] lg:text-[44px] font-semibold py-10">
          ...
          > 
           ...
           <div className="p-4 border-r-[1px] border-r-[#DDDDDD]">
            ...
            <button
              className="w-60 bg-[#F48C06] rounded-md p-4 text-[#FFFFFF] flex justify-center my-5 py-6"
              type="submit"
            >
